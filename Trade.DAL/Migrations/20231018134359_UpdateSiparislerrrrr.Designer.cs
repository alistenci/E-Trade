...
namespace Trade.DAL.Migrations
{
    ...
    [Migration("20231018134359_UpdateSiparislerrrrr")]
    partial class UpdateSiparislerrrrr
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trade.DAL.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Ad_Soyad = "Mehmet Ali",
                            Kullanici_Adi = "ali",
                            LastLoginDate = new DateTime(2023, 10, 18, 16, 43, 59, 562, DateTimeKind.Local).AddTicks(6404),
                            LastLoginIP = "",
            ...
            modelBuilder.Entity("Trade.DAL.Entities.Siparis_Detay", b =>
                {
                    b.HasOne("Trade.DAL.Entities.AdminSiparis", null)
                        .WithMany("SiparisDetayi")
                        .HasForeignKey("AdminSiparisId");
